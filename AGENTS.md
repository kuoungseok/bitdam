...
distribution repository or GitHub Pages worktree.
...
- Do not use the legacy product name as visible product copy.
...
- Check that the legacy product name is not used as visible product copy.
